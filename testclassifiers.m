...
function [ mistakes, a, confusionTable, errorScannedDigits ] = testclassifiers( trainSet, testSet, a, nDigits, kernelMatrixTest,errorScannedDigits )
% Test perceptron 
...
for i=1:length(testSet)
    ...
    updateKernel=kernelMatrixTest(i,:);
    ...
    if maxi~=realY
        %update confusion table and scanned digit error every time we make
        %a mistake
